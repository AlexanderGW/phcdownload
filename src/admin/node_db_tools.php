...
switch( $kernel->vars['action'] )
{
	...
	case "prune" :
	{
		...
		if( isset( $_POST['form_file_prune'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_orphaned_files_deleted", $count, $prune_data );
		}
		...
		if( isset( $_POST['form_cate_prune'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_orphaned_categories_deleted", $count, $prune_data );
		}
		...
		if( isset( $_POST['form_comm_prune'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_orphaned_comments_deleted", $count, $prune_data );
		}
		...
		if( isset( $_POST['form_fiel_prune'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_orphaned_fields_deleted", $count );
		}
		...
		if( isset( $_POST['form_vote_prune'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_orphaned_votes_deleted", $count );
		}
		...
		if( isset( $_POST['form_user_prune'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_orphaned_users_deleted", $count, $prune_data );
		}
		...
		if( isset( $_POST['form_comm_prune_old'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_old_comments_deleted", $_POST['form_comm_prune_old_days'] );
		}
		...
		if( isset( $_POST['form_syslog_prune_old'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_old_system_deleted", $_POST['form_syslog_prune_old_days'] );
		}
		...
		if( isset( $_POST['form_dllog_prune_old'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_old_download_deleted", $_POST['form_dllog_prune_old_days'] );
		}
		...
		if( isset( $_POST['form_lelog_prune_old'] ) )
		{
			...
			$kernel->admin->message_admin_report( "log_old_leech_deleted", $_POST['form_lelog_prune_old_days'] );
		}
	...
	case "clean" :
	{
		...
		{
			$kernel->page->message_report( $kernel->ld['phrase_no_category_selected'], M_ERROR );
		}
		elseif( $kernel->vars['usergroup_id'] == 0 AND isset( $_POST['form_user_move'] ) )
		{
			$kernel->page->message_report( $kernel->ld['phrase_no_usergroup_selected'], M_ERROR );
		}
		else
		{
			//move orph files
			if( isset( $_POST['form_file_move'] ) )
			{
				...
				$kernel->admin->message_admin_report( "log_orphaned_files_moved", $count, $move_data );
			}
			...
			if( isset( $_POST['form_cate_move'] ) )
			{
				...
				$kernel->admin->message_admin_report( "log_orphaned_categories_moved", $count, $move_data );
			}
			...
			if( isset( $_POST['form_user_move'] ) )
			{
				...
				$kernel->admin->message_admin_report( "log_orphaned_users_moved", $count, $move_data );
			}
		}
